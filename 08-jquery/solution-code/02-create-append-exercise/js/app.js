...
const headingText = document.createTextNode("About Us");
const p1Text = document.createTextNode("Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rerum fugiat illo sunt quasi incidunt veniam cumque minus totam rem ea vel ut eius, accusamus, doloribus dolore at ipsum quaerat molestias.");
const p2Text = document.createTextNode("Explicabo consectetur tempora perferendis voluptas itaque, corporis at ipsum quisquam eveniet, facilis perspiciatis. Eum ad adipisci, earum fugit perspiciatis deserunt veniam eos? Impedit expedita assumenda, saepe excepturi ad voluptatibus. Eveniet.");
...
const imageSource = "images/about.jpg";
...
const issuesHead = document.createElement('h3');
const list = document.createElement('ul');
const item1 = document.createElement('li'); // could also use a loop here to DRY out the code
...
const issuesHeadText = document.createTextNode("Recent Issues");
const item1Text = document.createTextNode("Issue Nineteen: Camping"); // could also create an array of values and use a loop
const item2Text = document.createTextNode("Issue Eighteen: Food");
const item3Text = document.createTextNode("Issue Seventeen: Signs");
const item4Text = document.createTextNode("Issue Sixteen: Friends");
const item5Text = document.createTextNode("Issue Fifteen: Carnivals");
const item6Text = document.createTextNode("Issue Fourteen: Gatherings");
